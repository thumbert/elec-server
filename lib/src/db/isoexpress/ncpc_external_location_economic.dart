...
class NcpcExternalLocationEconomicArchive extends DailyIsoExpressReport {
  ...
  final String reportName =
      'External Location Economic Net Commitment Period Compensation';
  ...
  String getUrl(Date? asOfDate) =>
      'https://www.iso-ne.com/transform/csv/ncpc/daily?ncpcType=extloceconomic&start=${yyyymmdd(asOfDate)}';
  ...
  Map<String, dynamic> converter(List<Map<String, dynamic>> rows) {
    ...
    if (!_setEq.equals(row.keys.toSet(), _columnNames)) {
      throw ArgumentError(
          'Report $reportName for ${row['Operating Day']} has changed format!');
    }
