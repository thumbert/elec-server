...
class SdRtNcpcPymt {
  ...
  Future<ApiResponse> data0ForAsset(
      String accountId, int assetId, String start, String end) async {
    var query = where
      ..eq('account', accountId)
      ..eq('tab', 0)
      ..gte('date', start)
  ...
  Future<ApiResponse> data2CreditDetails(
