...
class SrRegSummary {
  ...
  Future<ApiResponse> apiGetTab0ByLocationColumn(
      String accountId, String columnName, String start, String end) async {
    var startDate = Date.parse(start);
    var endDate = Date.parse(end);
  ...
  Future<ApiResponse> apiGetTab1ByLocationColumn(String accountId,
    ...
    var endDate = Date.parse(end);
    var data =
        await getData(accountId, subaccountId, columnName, startDate, endDate);
    return ApiResponse()..result = json.encode(data);
  }
