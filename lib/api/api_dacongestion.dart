...
/// A region agnostic API for DA congestion for all FTR/TCC nodes of interest.
class DaCongestionCompact {
  ...
  DaCongestionCompact(mongo.Db db, {required this.iso}) {
  ...
  Router get router {
    ...
    ///   'ptids': [321, 322, 323, ...],
    ///   'congestion': [
    ///      [15, 0.02, 32, 0.01, 12, 0.0, ...],  // for HE0
    ///      [...], // for HE1
    ///      ...
    ///   ],
    /// }
