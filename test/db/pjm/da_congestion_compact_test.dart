...
Future<void> tests(String rootUrl) async {
  group('Pjm DAM congestion compact db tests: ', () {
    var archive = PjmDaCongestionCompactArchive();
    setUp(() async {
    ...
    test('process 2022-03-01', () async {
      var res = archive.processDate(Date.utc(2022, 3, 1));
      expect(res.length, 1);
      expect(res.first.keys.toSet(), {'date', 'ptids', 'congestion'});
  ...
  // group('Pjm DAM congestion compact api tests: ', () {
  ...
  // });
  //
  // group('Pjm DAM congestion compact client tests: ', () {
  //   var cong =
