...
void tests() {
  group('lib_settlements test', () {
    ...
    test('two groups', () {
      ...
      var out0 =
          getNthSettlement(xs, (e) => (e['date'], e['product']), n: 0);
      expect(out0, xs.sublist(0, 6));

      var out1 =
          getNthSettlement(xs, (e) => (e['date'], e['product']), n: 1);
      expect(out1, [xs[0], xs[1], xs[6], xs[7], xs[4], xs[5]]);

      var out2 =
          getNthSettlement(xs, (e) => (e['date'], e['product']), n: 2);
    ...
    test('two groups not ordered, maintains original order', () {
      ...
      var out0 =
          getNthSettlement(xs, (e) => (e['product'], e['date']), n: 0);
